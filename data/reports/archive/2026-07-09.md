# AI Daily Radar · 2026-07-09

- 时间窗：过去 24 小时
- 原始条目：13，去重后：13，应用层相关：11
...
1. 选一个与你当前工作流最接近的场景，围绕「Seedream 5.0 Pro 登陆 Runway，支持14种语言」写下 1 个可验证的小假设。
...
1. **蚂蚁灵波开源全球首个面向具身智能的MoE视频基模LingBot-Video** — IT之家（RSS）（模型能力）
   2026-07-09 15:06 CST
...
2. **蚂蚁灵波开源实时交互世界模型 LingBot-World 2.0** — IT之家（RSS）（模型能力）
   2026-07-09 14:53 CST
...
3. **Robbyant 发布 LingBot-VLA 2.0：开源 6B 跨实体机器人视觉-语言-动作模型** — MarkTechPost（RSS）（模型能力）
   2026-07-09 08:45 CST
...
4. **面向AI模型双重用途知识的"开关"：Anthropic与AE Studio提出GRAM方法** — Anthropic：Research（发表成果 · 网页）（论文研究）
   2026-07-09 07:27 CST
...
5. **Seedream 5.0 Pro 登陆 Runway，支持14种语言** — X：Runway (@runwayml)（产品与应用）
   2026-07-09 06:21 CST
   Seedream 5.0 Pro 现已登陆 Runway。可通过提示词或参考图生成高细节图像，图像内文字清晰可读，支持多达14种语言。立即点击下方链接尝试。
   https://x.com/runwayml/status/2074982268175630814

6. **诉讼：男子使用Grok制作7000张继女色情图像后自杀** — Ars Technica：AI（RSS）（行业与平台）
   2026-07-09 03:56 CST
...
7. **Replit 推出社区档案与力量排名** — X：Replit (@Replit)（产品与应用）
   2026-07-08 23:00 CST
   本周新功能 🚀 Replit 社区档案--vibe coders 的工作证明。

你的档案，你的展示。获取你的智能体使用和检查点的活跃度图表，外加面向专业用户的 Replit 力量排名。

登录，认领你的档案，挑选你最棒的项目，与朋友分享你的数据。

立即查看 → http://replit.com/community
   https://x.com/Replit/status/2074871322220339515

8. **OpenRouter聊天室推出一键零数据保留** — X：OpenRouter (@OpenRouter)（产品与应用）
   2026-07-08 22:57 CST
   新功能：聊天室一键ZDR（零数据保留）
在完全隐私保护下横向对比模型：https://openrouter.ai/chat
   https://x.com/OpenRouter/status/2074870468394250461

9. **OpenAI发布政府与国家安全合作伙伴关系方针** — OpenAI：官网动态（RSS · 排除企业/客户案例）（行业与平台）
   2026-07-08 21:30 CST
...
10. **OpenAI 审计 SWE-Bench Pro 发现约 30% 的评测任务存在缺陷** — OpenAI：官网动态（RSS · 排除企业/客户案例）（论文研究）
   2026-07-08 21:00 CST
...
11. **在校研究生Kunkun开源管理相互调用Skill的方法** — X：Berry Xia (@berryxia)（技巧与观点）
   2026-07-08 20:08 CST
   ...
   https://x.com/berryxia/status/2074827915779580055
